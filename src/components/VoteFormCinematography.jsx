...
import SelectCinematography from './SelectCinematography';
...
function VoteFormCinematography() {
  ...
  useEffect(() => {
    if (feedbackEditState.edit) {
      ...
      setCinematography(feedbackEditState.item.cinematography);
    }
  }, [
    feedbackEditState.edit,
    feedbackEditState.item.text,
    feedbackEditState.item.cinematography,
  ]);
  ...
  const handleSubmit = (e) => {
    ...
    if (text.trim().length > 1) {
      ...
      if (feedbackEditState.edit) {
        ...
        addItem(newFeedback, 'cinematography');
        setText('');
      }
    }
  };
  ...
  return (
    <Card>
      <form onSubmit={handleSubmit}>
        ...
        <SelectCinematography
          select={(cinematography) => setCinematography(cinematography)}
        />
